        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {owners.map((owner, index) => (
            <Card key={index} className="shadow-lg border-zutly-tiffany-dark flex flex-col items-center p-6">
              <Avatar className="h-40 w-40 mb-4 border-4 border-zutly-medium-blue">
                <AvatarImage src={owner.image} alt={owner.name} className="object-cover object-top filter-none" /> {/* Added filter-none */}
