  ...
  return (
    <div className="space-y-8">
      <div className="text-center md:text-left">
        <h2 className="text-3xl font-bold text-zutly-black mb-4">Neem direct contact op</h2>
      ...
      <div className="space-y-4">
        <Card className="flex items-center p-6 shadow-sm border-b-2 border-zutly-blue-gray">
          <Mail className="h-6 w-6 text-zutly-true-blue mr-4 flex-shrink-0" />
          <div>
            <h3 className="text-lg font-semibold text-zutly-black">E-mail</h3>
        ...
        <Card className="flex items-center p-6 shadow-sm border-b-2 border-zutly-blue-gray">
          ...
          <div>
            <h3 className="text-lg font-semibold text-zutly-black">Telefoon</h3>
        ...
        <Card className="flex items-center p-6 shadow-sm border-b-2 border-zutly-blue-gray">
          ...
          <div>
            <h3 className="text-lg font-semibold text-zutly-black">Locatie</h3>
      ...
      <div className="bg-zutly-blue-gray/20 p-6 rounded-lg shadow-sm border border-zutly-blue-gray">
        <h3 className="text-lg font-semibold text-zutly-black mb-2">Reactietijd</h3>
