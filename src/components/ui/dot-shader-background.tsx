...
function Scene() {
  ...
  const [trail, onMove] = useTrailTexture({
    ...
    maxAge: 400,
    interpolate: 1,
    ease: function easeInOutCirc(x: number) { // Type toegevoegd voor 'x'
  ...
  useEffect(() => {
    dotMaterial.uniforms.dotColor.value.setHex(parseInt(themeColors.dotColor.replace('#', ''), 16)) // parseInt voor hex
    dotMaterial.uniforms.bgColor.value.setHex(parseInt(themeColors.bgColor.replace('#', ''), 16)) // parseInt voor hex
