  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <section
          className="relative min-h-[30vh] flex flex-col items-center justify-center text-white overflow-hidden py-16 px-4 text-center"
          style={{
        ...
        >
          ...
          <div className="relative z-20 max-w-3xl mx-auto">
            ...
            <p className="text-xl md:text-2xl drop-shadow-sm">
              Neem contact met ons op voor vragen of een vrijblijvende offerte.
            </p>
          </div>
        </section>
        <section className="py-20 bg-zutly-blue-gray/10">
