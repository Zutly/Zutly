  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section 
          className="relative min-h-[50vh] flex flex-col items-center justify-center text-foreground overflow-hidden py-16 px-4 text-center" {/* text-white naar text-foreground */}
          style={{ 
        ...
        <section className="py-20 bg-card text-center"> {/* bg-zutly-tiffany-light/20 naar bg-card */}
          <div className="container mx-auto px-4 max-w-3xl">
            <h2 className="text-4xl font-bold text-foreground mb-6"> {/* text-zutly-dark-purple naar text-foreground */}
              Welke dienst past bij jouw bedrijf?
            </h2>
            <p className="text-lg text-muted-foreground mb-8"> {/* text-gray-700 naar text-muted-foreground */}
