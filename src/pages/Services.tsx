  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section 
          className="relative min-h-[50vh] flex flex-col items-center justify-center text-white overflow-hidden py-16 px-4 text-center"
          style={{ 
        ...
        >
          {/* Gradient Overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-zutly-black/65 via-zutly-true-blue/65 to-zutly-blue-gray/65 z-0"></div>
        ...
        <section className="py-20 bg-zutly-platinum/20 text-center">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <Link to="/contact">
              <Button className="bg-zutly-true-blue hover:bg-zutly-black text-white font-bold py-3 px-8 rounded-full text-lg shadow-xl hover:scale-105 transition-all duration-300">
                Vraag advies aan
              </Button>
            </Link>
          </div>
