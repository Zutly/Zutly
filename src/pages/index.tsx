    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        >
          ...
          {/* Aurora Background */}
          <AuroraBackground className="absolute inset-0 z-20"> {/* Added z-20 to place it above gradient and pattern */}
            <div className="relative z-20 text-center px-4"> {/* Existing content, now inside AuroraBackground */}
