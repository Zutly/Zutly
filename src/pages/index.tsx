  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <section 
          className="relative min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-zutly-dark-purple/80 via-zutly-medium-blue/80 to-zutly-tiffany-dark/80 text-white overflow-hidden py-16"
          style={{ 
