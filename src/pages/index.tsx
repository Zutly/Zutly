  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <section 
          className="relative min-h-[70vh] flex items-center justify-center text-foreground overflow-hidden py-16" {/* text-white naar text-foreground */}
          style={{ 
        ...
        />
        <WaveSeparator topBgColorVar="--background" bottomBgClass="bg-card" /> {/* bottomBgClass aangepast */}
