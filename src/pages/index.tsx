  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <section 
          className="relative min-h-[70vh] flex items-center justify-center text-white overflow-hidden py-16"
          style={{ 
        ...
        >
          ...
          <div className="relative z-20 text-center px-4">
            <h1 className="text-5xl md:text-6xl font-extrabold mb-4 leading-tight drop-shadow-md">
              Welkom bij <span className="text-zutly-platinum">Zutly</span>
            </h1>
        ...
        />
        <WaveSeparator topBgColorVar="--background" bottomBgClass="bg-zutly-blue-gray/10" />
